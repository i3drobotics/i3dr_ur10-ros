...
class GtkHandler:
    def __init__(self):
        ...
        self.gladefile = rospack.get_path(
            'i3dr_ur10') + '/ui/roomScanUR10.glade'
        ...
        self.lblUR10ShoulderAngle = self.builder.get_object(
            "lblUR10ShoulderAngle")
        ...
        self.sub_left_image = rospy.Subscriber(
            "left/image_raw", Image, self.get_left_image)
        self.sub_right_image = rospy.Subscriber(
            "right/image_raw", Image, self.get_right_image)
        self.sub_disparity_image = rospy.Subscriber(
            "disparity", DisparityImage, self.get_disparity_image)
